...
class ContractController extends Controller
{
    ...
    public function edit($contract_id)
    {
        ...
        $info_data_partner = Partner::with('contract')->get()->where('id', '=', $info_data['partnerId'])->first();
        $page_title = 'Chi tiết hợp đồng';
        $page_description = 'Thông tin chi tiết hợp đồng';
        $logo = "images/logo.png";
        $logoText = "images/logo-text.png";
        $action = __FUNCTION__;
        return view('back-end.contract.edit', compact('page_title', 'page_description', 'action', 'logo', 'logoText', 'info_data', 'info_data_partner', 'contract_count'));
    }
