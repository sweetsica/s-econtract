...
class DoppelherzSignController extends Controller
{
    ...
    {
        return view('back-end.signature.doppelherzsigntest');
    }
    /**
    ...
    public function store_test(Request $request)
    {
        ...
        $file = $folderPath . $request['name']. '.'.$image_type;
        file_put_contents($file, $image_base64);
        $url_true = url('uploads/signature/doppelherz/').$request['name'].'.png';
        dd($url_true);
    }
