...
//            Toàn bộ fields t  rường partner bắt buộc, trừ owner_token
            $checkPartner = Partner::where('owner_phone',$request->owner_phone)->orWhere('owner_email',$request->owner_email)->orWhere('owner_id_numb',$request->owner_id_numb)->first();
            if($checkPartner){
