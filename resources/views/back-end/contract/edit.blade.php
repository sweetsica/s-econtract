                                ...
                                <div>
                                    <div class="d-md-flex d-block mb-sm-5 mb-3">
                                        <div class="mr-auto mb-md-0 mb-4">
                                            <h2 class="font-w600 text-black">Đại lý {{$info_data['store_name']}}</h2>
...
{{--													45 Connor St. London, 44523</span>--}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 fs-20 mt-3">
                                            <span class="font-w600 text-black">Địa chỉ:</span>  {{$info_data['store_add_DKKD']}}
                                        </div>
                                        <div class="col-md-12 fs-20 mt-3">
                                            <span class="font-w600 text-black">Địa chỉ giao hàng:</span> {{$info_data['store_add_GH']}}
                                        </div>
                                        <div class="col-md-6 fs-20 mt-3">
                                            <span class="font-w600 text-black">SĐT Đại lý:</span> {{$info_data['store_phone']}}
                                        </div>
                                        <div class="col-md-6 fs-20 mt-3">
                                            <span class="font-w600 text-black">Phạm vi bán hàng:</span> {{$info_data['store_effect']}}
                                        </div>
                                        <div class="col-md-6 fs-20 mt-3">
                                            <span class="font-w600 text-black">Số giấy phép ĐKKDD:</span> {{$info_data['store_id_Numb_GPDKKD']}}
                                        </div>
                                        <div class="col-md-6 fs-20 mt-3">
                                            <span class="font-w600 text-black">Ngày cấp GPĐKKD:</span>  {{$info_data['store_GPDKKD']}}
                                        </div>
                                        <div class="col-md-6 fs-20 mt-3">
                                            <span class="font-w600 text-black">Người liên hệ:</span>  {{$info_data['store_contact_name']}}
                                        </div>
                                        <div class="col-md-6 fs-20 mt-3">
                                            <span class="font-w600 text-black">Chức danh :</span>  {{$info_data['store_contact_position']}}
                                        </div>
                                        <div class="col-md-12 fs-20 mt-3">
                                            <span class="font-w600 text-black">SĐT Người liên hệ:</span> {{$info_data['store_contact_phone']}}
                                        </div>
                                        <div class="col-md-6 fs-20 mt-3">
                                            <span class="font-w600 text-black">Chủ ngân hàng:</span> {{$info_data['store_bank_holder']}}
                                        </div>
                                        <div class="col-md-6 fs-20 mt-3">
                                            <span class="font-w600 text-black">Tên ngân hàng :</span> {{$info_data['store_bank']}}
                                        </div>
                                        <div class="col-md-12 fs-20 mt-3">
                                            <span class="font-w600 text-black">Số tài khoản:</span> {{$info_data['store_bank_numb']}}
                                        </div>
                                        <div class="col-md-6 fs-20 mt-3">
                                            <span class="font-w600 text-black">Ngày bắt đầu:</span> {{$info_data['store_started']}}
                                        </div>
                                        <div class="col-md-6 fs-20 mt-3">
                                                ...
                                                <div class="modal-dialog modal-xl modal-dialog modal-dialog-centered">
                                                    <form action="{{route('contract.update',[$info_data['id']])}}" method="post" class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLongTitle">Chỉnh sửa hợp đồng</h5>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="store_name" value="{{$info_data['store_name']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên đại lý...">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="store_phone" value="{{$info_data['store_phone']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên sđt...">
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="store_website" value="{{$info_data['store_website']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập đường dẫn...">
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label for="address">Địa chỉ GH</label>
                                                                        <textarea name="store_add_DKKD"  class="form-control" id="address" placeholder="Địa chỉ chi tiết">{{$info_data['store_add_DKKD']}}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail1">Tên chủ tài khoản ngân hàng</label>
                                                                        <input name="store_bank_holder" value="{{$info_data['store_bank_holder']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập họ và tên...">
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="store_bank" value="{{$info_data['store_bank']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên ngân hàng...">
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="store_bank_numb" value="{{$info_data['store_bank_numb']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập stk...">
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail1">Người lên hệ</label>
                                                                        <input name="store_contact_name"  value="{{$info_data['store_contact_name']}}"  type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên...">
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="store_contact_position" value="{{$info_data['store_contact_position']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập chức danh...">
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail1">SĐT Người lên hệ</label>
                                                                        <input name="store_contact_phone" value="{{$info_data['store_contact_phone']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập sđt...">
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail1">Số giấy phép ĐKKD</label>
                                                                        <input name="store_id_Numb_GPDKKD" value="{{$info_data['store_id_Numb_GPDKKD']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập số GPĐKKD...">
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail1"> Ngày cấp GPĐKKD</label>
                                                                        <input name="store_GPDKKD" value="{{$info_data['store_GPDKKD']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập ngày cấp GPĐKKD...">
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="store_add_GH" class="form-control" id="address" placeholder="Địa chỉ chi tiết">{{$info_data['store_add_GH']}}</textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail1">Cấp hợp đồng</label>
                                                                        <select name="contract_level" class="form-control">
                                                                            <option {{$info_data['contract_level']== 1 ? 'selected':''}} value="1">Hợp đồng cấp 1</option>
                                                                            <option {{$info_data['contract_level']== 2 ? 'selected':''}} value="2">Hợp đồng cấp 2</option>
                                                                            <option {{$info_data['contract_level']== 3 ? 'selected':''}} value="3">Hợp đồng cấp 3</option>
                                                                            <option {{$info_data['contract_level']== 4 ? 'selected':''}} value="4">Hợp đồng cấp 4</option>
                                                                        </select>
                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                    </div>
                                                                </div>
                            ...
                            <div class="card-body">
                                <div id="accordion-nine" class="accordion accordion-active-header">
                                    @foreach($info_data_parent->contract as $data)
                                        @if($data->id !== $info_data->id)
                                        <div class="accordion__item">
                                            <div class="accordion__header" data-toggle="collapse" data-target="#contract_{{$data['id']}}">
                                                <span class="accordion__header--icon"></span>
                                                <span class="accordion__header--text">{{$data['store_name']}}</span>
                                            ...
                                            <div id="contract_{{$data['id']}}" class="collapse accordion__body {{$loop->index == 0 ? 'show' :''}}" data-parent="#accordion-nine">
                                                <div class="py-4 px-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 fs-20 mt-3">
                                                            <span class="font-w600 text-black">Người liên hệ:</span>  {{$data['store_contact_name']}}
                                                        </div>
                                                        <div class="col-md-6 fs-20 mt-3">
                                                            <span class="font-w600 text-black">Chức danh :</span>  {{$data['store_contact_position']}}
                                                        </div>
                                                        <div class="col-md-12 fs-20 mt-3">
                                                            <span class="font-w600 text-black">SĐT Người liên hệ:</span> {{$data['store_contact_phone']}}
                                                        </div>
                                                            <div class="col-md-6 fs-20 mt-3">
                                                        ...
                                                        <div class="col-md-6 fs-20 mt-3">
                                                            <span class="font-w600 text-black">Ngày bắt đầu:</span> {{$data['store_started']}}
                                                        </div>
                                                        <div class="col-md-6 fs-20 mt-3">
                                                            <span class="font-w600 text-black">Ngày kết thúc:</span> {{$data['store_end']}}
                                                        </div>
                                                        <div class="col-md-12 mt-5">
                                                            <button type="button" class="btn light btn-sm btn-primary"  data-toggle="modal" data-target=".bd-example-modal-lg">Chỉnh sửa hợp đồng</button>
                                                            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-xl modal-dialog modal-dialog-centered">
                                                                    <form action="{{route('contract.update',[$data['id']])}}" method="post" class="modal-content">
                                                                        @csrf
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalLongTitle">Chỉnh sửa hợp đồng</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Tên đại lý</label>
                                                                                        <input name="store_name" value="{{$data['store_name']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên đại lý...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Số điện thoại</label>
                                                                                        <input name="store_phone" value="{{$data['store_phone']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên sđt...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Website</label>
                                                                                        <input name="store_website" value="{{$data['store_website']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập đường dẫn...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="address">Địa chỉ GH</label>
                                                                                        <textarea name="store_add_DKKD"  class="form-control" id="address" placeholder="Địa chỉ chi tiết">{{$data['store_add_DKKD']}}</textarea>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Tên chủ tài khoản ngân hàng</label>
                                                                                        <input name="store_bank_holder" value="{{$data['store_bank_holder']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập họ và tên...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Tên ngân hàng</label>
                                                                                        <input name="store_bank" value="{{$data['store_bank']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên ngân hàng...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Số tài khoản ngân hàng</label>
                                                                                        <input name="store_bank_numb" value="{{$data['store_bank_numb']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập stk...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Người lên hệ</label>
                                                                                        <input name="store_contact_name"  value="{{$data['store_contact_name']}}"  type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Chức danh</label>
                                                                                        <input name="store_contact_position" value="{{$data['store_contact_position']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập chức danh...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">SĐT Người lên hệ</label>
                                                                                        <input name="store_contact_phone" value="{{$data['store_contact_phone']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập sđt...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Số giấy phép ĐKKD</label>
                                                                                        <input name="store_id_Numb_GPDKKD" value="{{$data['store_id_Numb_GPDKKD']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập số GPĐKKD...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1"> Ngày cấp GPĐKKD</label>
                                                                                        <input name="store_GPDKKD" value="{{$data['store_GPDKKD']}}" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập ngày cấp GPĐKKD...">
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="address">Địa chỉ ĐKKD</label>
                                                                                        <textarea name="store_add_GH" class="form-control" id="address" placeholder="Địa chỉ chi tiết">{{$data['store_add_GH']}}</textarea>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Cấp hợp đồng</label>
                                                                                        <select name="contract_level" class="form-control">
                                                                                            <option {{$data['contract_level']== 1 ? 'selected':''}} value="1">Hợp đồng cấp 1</option>
                                                                                            <option {{$data['contract_level']== 2 ? 'selected':''}} value="2">Hợp đồng cấp 2</option>
                                                                                            <option {{$data['contract_level']== 3 ? 'selected':''}} value="3">Hợp đồng cấp 3</option>
                                                                                            <option {{$data['contract_level']== 4 ? 'selected':''}} value="4">Hợp đồng cấp 4</option>
                                                                                        </select>
                                                                                        {{--                                                                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--}}
                                                                                    </div>
                                                                                </div>
