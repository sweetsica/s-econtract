...
<div id="signature-pad" class="signature-pad">
    <div class="signature-pad--body">
        <canvas style="border: 1px black solid"></canvas>
    </div>
    <div class="signature-pad--footer">
        <div class="description">Doppelherz - Vui lòng kí ở trên</div>
...
<script src="{{asset('assets/signature/js/signature_pad.js')}}"></script>
