                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <button type="button" class="btn btn-primary shadow btn-xs sharp mr-1"
                                                        data-toggle="modal" data-target="#partner-edit-{{$data['id']}}">
                                            ...
                                            <div class="modal fade" id="partner-edit-{{$data['id']}}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered"
                                                     role="document">
                                                    <form action="{{route('partner.update',[$data['id']])}}" method="post" class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    <label>Nơi cấp</label>
                                                                    <textarea name="owner_id_numb_created_locate" class="form-control" rows="2"  spellcheck="false">{{$data['owner_id_numb_created_locate']}}</textarea>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    ...
                                                                    <select name="owner_sex" class="form-control">
                                                                        <option {{$data['owner_sex'] == "Nam" ? "selected" : ""}} value="Nam">Nam</option>
                                                                        <option {{$data['owner_sex'] == "Nữ" ? "selected" : ""}} value="Nữ">Nữ</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
