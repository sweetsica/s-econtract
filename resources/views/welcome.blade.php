...
<div
    class="relative flex items-top sm:px-3 justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    <div class="text-center w-full px-3">
        ...
        <h1 class="text-2xl font-black text-gray-800 my-5">Chào Mừng Đến Với Hợp Đồng Điện Tử</h1>
